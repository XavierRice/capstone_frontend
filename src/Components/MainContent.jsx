...
function MainContent() {
  ...
  return (
    ...
    <div className=" ">
      <Row>
        {mockEventData.slice(startIndex, startIndex + eventsPerPage).map((event) => (
      ...
      <div className="d-flex justify-content-center ">
        <Button onClick={handlePrev} disabled={startIndex === 0} className="me-2">
          Prev
        </Button>
        <Button onClick={handleNext} disabled={startIndex + eventsPerPage >= mockEventData.length}>
          Next
        </Button>
      </div>
    </div>
